...
namespace Threecomerce\NewsletterPrivacy\Controller\Subscriber;
...
class NewAction extends SubscriberController implements HttpPostActionInterface
{
    ...
    public function execute()
    {
        if ($this->getRequest()->isPost() && $this->getRequest()->getPost('email') && (
                $this->getRequest()->getParam('newsletter_privacy')=='on' ||
                $this->getRequest()->getParam('newsletter_privacy-popup') =='on')) {
